    ...
    <div id="activityanalysis">
        <el-row>
            ...
            <el-col
                :span="3">
                <el-select
                    v-model="selectProductFrom.activityId"
                    placeholder="请选择activity id"
                    >
                    <el-option
...
export default {
    ...
    methods: {
        ...
        initProductsData(){
            this.axios.get("/api/v1/JDForecast/getActivityForecastProducts", {
                params:{
                    currentPage: this.productsPage.current,
                    showCount: this.productsPage.showCount,
                    activityId: this.selectProductFrom.activityId,
        ...
        // 获取activities数据
        initShopsData(){
            this.axios.get("/api/v1/JDForecast/getForecastActivities", {
                params:{
