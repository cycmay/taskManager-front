            ...
            <el-col class="main-col" :span="24">
                <el-table 
                    ...
                    <el-table-column label="img" width="120"
                        ...
                        >
                        <template slot-scope="scope">
                            <img :src="scope.row.imageUrl" width="120" style="margin-right:5px">
                        </template>
                    </el-table-column>
...
export default {
    ...
    methods: {
        ...
        initProductsData(){
            this.axios.get("/api/v1/JDForecast/getVIPForecastProducts", {
                params:{
        ...
        handleViewProductJD(index, row){
            window.open("https://m.vip.com/product-"+ row.productId +".html","", "height=900, width=600");
        },
